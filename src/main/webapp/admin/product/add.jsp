...
<body style="background-color: #f8f9fa !important;">
    ...
    <div class="card">
       	...
       	<c:set var="title" value="Adicionar Produto"/>
		<c:if test="${command.productId > 0}">
		   <c:set var="action" value="/admin/product/update"/>
       		<c:set var="title" value="Alterar Informações do Produto"/>
		</c:if>
        ...
        <div class="card-body">
            <form:form action="${action}" method="post">
                ...
                <div class="form-group">
                    <label for="productPrice" class="control-label">Preço do Produto</label>
                ...
                <div class="form-group">
                    <label for="productQty" class="control-label">Quantidade do Produto</label>
                ...
                <div class="form-group">
                    <label for="productCategory" class="control-label">Categoria do Produto</label>
