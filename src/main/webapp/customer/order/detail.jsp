...
<body style="background-color: #f8f9fa !important;">
    ...
    <div class="card">
        <div class="card-header text-white shadow bg-dark">
            <h2 class="float-left">Detalhes do Pedido</h2>
        </div>
        <div class="card-body">
        	ID do Pedido: <%= order.getId() %><br>
        	Status do Pedido: <%= order.getStatus() %><br>
        	Data do Pedido: <%= order.getCreateDateTime() %><br>
        	<hr>
        	<br>
                ...
                <tbody>
                    <%
                        ...
                        <tr>
                            ...
                            <td><%= op.getBuyqty() %></td>
                            <td>R$ <%= op.getBuyqty() * op.getProduct().getProductPrice() %></td>
                        </tr>
                        <%   
