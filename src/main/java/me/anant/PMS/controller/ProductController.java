...
public class ProductController {
	...
	/**
	 * Essa API é responsável por adicionar produto.
	 * @param product
	 * @param result
	 * @param model
	...
	public String add(@ModelAttribute("command") @Valid Product product, BindingResult result, Model model, final RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("msg", "Produto adicionado!");
	...
	/**
	 * Esse GET é responsavel por deletar o produto.
	 * @param id
	 * @param redirectAttributes
	...
	/**
	 * Esse POST é responsável por modificar o produto.
	 * @param product
	 * @param result
	 * @param model
	 * @param redirectAttributes
	...
	public String updateView(@ModelAttribute("command") @Valid Product product, BindingResult result, Model model, final RedirectAttributes redirectAttributes) {
		...
		productService.save(product);
		redirectAttributes.addFlashAttribute("msg", "Produto Alterado!");
		redirectAttributes.addFlashAttribute("class", "alert-success");
		return "redirect:/admin/product/list";
	}
